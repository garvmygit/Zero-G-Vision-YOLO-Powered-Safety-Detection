#!/usr/bin/env python3
"""
Complete YOLO Safety Equipment Detection System
Combines frontend, dataset, and live detection
"""
...
def create_html_template():
    """Create the HTML template with visual detection capabilities"""
        ...
        <div class="detection-panel">
            ...
            <div id="detectionResults" class="detection-results">
                ...
                <div id="resultsContent">
                    <p style="text-align: center; color: #718096; padding: 40px;">Start camera detection or upload an image to see results</p>
                </div>
            </div>
        </div>
    </div>
        ...
        class SafetyEquipmentDetector {
            ...
            async detectObjects(imageData) {
                try {
                    ...
                    return [
                        { class: 'FireExtinguisher', confidence: 0.92, bbox: [100, 150, 200, 300] },
                        { class: 'FirstAidBox', confidence: 0.87, bbox: [300, 200, 150, 200] }
                    ];
                }
            }
