#!/usr/bin/env python3
"""
Simple Gesture-Controlled Safety Equipment Detection System
Uses basic computer vision for gesture recognition
"""
...
def detect_gesture_simple(image_cv):
    ...
    try:
        ...
        if aspect_ratio > 1.2:  # Tall and narrow
            return "point"  # Pointing gesture
        elif aspect_ratio < 0.8:  # Short and wide
            return "fist"  # Fist gesture
        elif area > 20000:  # Large area
    ...
    <body>
        <div class="container">
            <div class="header">
                ...
                <p>Control camera and detection with simple hand gestures</p>
            </div>
...
def detect_gesture():
    ...
    try:
        ...
        # Detect gesture using simple computer vision
        gesture = detect_gesture_simple(image_cv)
...
if __name__ == '__main__':
    ...
    print("🤚 Simple gesture control enabled!")
